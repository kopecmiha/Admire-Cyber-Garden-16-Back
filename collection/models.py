...
'''class CardTrade(models.Model):
    user1 = models.ForeignKey(to=User, on_delete=models.CASCADE, blank=False, null=False, related_name="trade_user1")
    user2 = models.ForeignKey(to=User, on_delete=models.CASCADE, blank=False, null=False, related_name="trade_user2")
    offered_cards = ArrayField()'''